...
const OngoingAuctionsSection = () => {
    ...
    // Auction data with only ongoing auctions (tạm thời dùng dữ liệu cứng)
    const auctionData = [
        {
            id: 4,
            image: "/assets/PastAuctionsSection/Tuong_dong_co.png",
            title: "Quyền sử dụng đất và tài sản gắn liền với đất tại thửa đất số: 12, 17 tờ bản đồ số: 49, địa chỉ: Xã Bình Giã, Huyện Châu Đức, Tỉnh Bà Rịa - Vũng Tàu",
            status: "Đang diễn ra",
            openTime: "17/06/2025 14:30:00",
            closeTime: "17/06/2025 18:30:00",
            endDateTime: "2025-06-17T15:30:00",
            type: "voluntary",
        },
        {
            id: 9,
            image: "/assets/PastAuctionsSection/sample.png",
            title: "Sản phẩm khác đang diễn ra",
            status: "Đang diễn ra",
            openTime: "17/06/2025 16:00:00",
            closeTime: "17/06/2025 18:00:00",
            endDateTime: "2025-06-17T18:00:00",
            type: "public",
        },
        {
            id: 10,
            image: "/assets/PastAuctionsSection/sample2.png",
            title: "Sản phẩm đấu giá thứ ba đang diễn ra",
            status: "Đang diễn ra",
            openTime: "17/06/2025 17:00:00",
            closeTime: "17/06/2025 19:00:00",
            endDateTime: "2025-06-17T19:00:00",
            type: "public",
        },
    ];
    ...
    const currentAuctions = filteredAuctions.slice(startIndex, startIndex + itemsPerPage).slice(0, itemsPerPage);
    ...
    const handleDetailClick = (auctionId) => {
        ...
        if (auction) {
            ...
            setStatusFilters(prev => ({
                ...prev,
                all: false,
                upcoming: auction.status === 'Chưa diễn ra',
                ongoing: auction.status === 'Đang diễn ra',
                ended: auction.status === 'Đã kết thúc',
            }));
        }
    ...
    return (
        <section className="ongoing-auctions-section">
            <div className="page-header">
                ...
                <div className="breadcrumb"><Link to="/" style={{ textDecoration: 'none', color: '#666' }}>Trang chủ</Link> / Cuộc đấu giá</div>
            </div>
